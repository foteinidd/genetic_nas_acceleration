...
def NAS_EA_FA_V2_train_101():
    ...
    if not os.path.exists('results_nas_ea_fa_v2_dnc101_train'):
        os.mkdir('results_nas_ea_fa_v2_dnc101_train')
    for exp_repeat_index in range(EXP_REPEAT_TIMES):
        start_time = time.time()
        folder_name = os.path.join('results_nas_ea_fa_v2_dnc101_train', 'results' + str(exp_repeat_index + 1))
