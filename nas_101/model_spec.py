# from https://github.com/google-research/nasbench/blob/master/nasbench/lib/model_spec.py
...
class ModelSpec(object):
    ...
    def __init__(self, matrix, ops, prune=False, data_format='channels_last'):
